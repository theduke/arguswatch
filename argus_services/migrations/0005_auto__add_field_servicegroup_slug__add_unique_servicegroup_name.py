...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceGroup.slug'
        db.add_column('argus_services_servicegroup', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, default='slug'),
                      keep_default=False)

        # Adding unique constraint on 'ServiceGroup', fields ['name']
        db.create_unique('argus_services_servicegroup', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ServiceGroup', fields ['name']
        db.delete_unique('argus_services_servicegroup', ['name'])

        # Deleting field 'ServiceGroup.slug'
        db.delete_column('argus_services_servicegroup', 'slug')
    ...
    models = {
        ...
        'argus_services.contact': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'contacts'", 'to': "orm['argus_services.ContactGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'argus_services.httppluginconfig': {
            ...
            'servicepluginconfiguration_ptr': ('django.db.models.fields.related.OneToOneField', [], {'primary_key': 'True', 'to': "orm['argus_services.ServicePluginConfiguration']", 'unique': 'True'}),
            'timeout': ('django.db.models.fields.IntegerField', [], {'default': '30'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '500'})
        },
        'argus_services.service': {
            'Meta': {'object_name': 'Service'},
            'celery_task_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True', 'default': "''"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'related_name': "'services'", 'to': "orm['argus_services.ServiceGroup']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'children'", 'to': "orm['argus_services.Service']"}),
        ...
        'argus_services.servicegroup': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'null': 'True', 'related_name': "'children'", 'to': "orm['argus_services.ServiceGroup']"}),
