...
urlpatterns = patterns('',
    ...
    url(r'^services/grouped$', services_list_grouped, name="argus_services_grouped_all"),
    url(r'^services/grouped/(?P<slug>[a-zA-Z0-9_\-]+)$', services_list_grouped, name="argus_services_grouped"),
    ...
    url(r'^services/service/(?P<pk>\d+)/run$', 'arguswatch.argus_services.views.run_service_check', name="argus_service_check"),
)
